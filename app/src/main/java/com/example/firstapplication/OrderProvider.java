...
public class OrderProvider extends ContentProvider {
    ...
    static final String DATABASE_NAME = "OrderDB";
    ...
    static final String PROVIDER_NAME = "com.example.firstapplication.orderprovider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "com.example.firstapplication.orderprovider/order";
            default:
