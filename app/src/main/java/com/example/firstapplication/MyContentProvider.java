...
public class MyContentProvider extends ContentProvider {
    ...
    static final String DATABASE_NAME = "StaffLoginDB";
    ...
    static final String PROVIDER_NAME = "com.example.firstapplication.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "com.example.firstapplication.provider/Staff";
            default:
